...
public class CloudVisionTextDetectionResult {
    ...
    public CloudVisionTextDetectionResult() {
    }

    public CloudVisionTextDetectionResult(EntityAnnotation entityAnnotation) {
